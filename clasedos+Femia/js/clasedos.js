...
//Ejercicio2
let textoUsuario = prompt("Por favor, ingresa la palabra Hola");

if (textoUsuario == "Hola"){

    console.log("¡Hola está bien escrito!")
    alert("¡Hola está bien escrito!")

}else if(textoUsuario == "hola"){ 
    console.log("Hola no está bien escrito");
    alert("Hola no está bien escrito");
}

//Ejercicio3
let numeroSolicitadoDos = prompt("Por favor, ingresá un número entre 10 y 50");

if (numeroSolicitadoDos >= 10 && numeroSolicitadoDos <= 50){

console.log("Tu número es correcto")
